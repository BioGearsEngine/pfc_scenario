...
#ifndef VER_0_3_PFC_SCENARIO_COMPLEX_TYPES_0_3_HXX
#define VER_0_3_PFC_SCENARIO_COMPLEX_TYPES_0_3_HXX
...
namespace pfc
{
  namespace schema
  {
    ...
    class SUSTAIN_XSD_API numeric_range: public ::xml_schema::type
    {
      ...
      // upper_bound
      //
      typedef ::xml_schema::double_ upper_bound_type;
      typedef ::xsd::cxx::tree::traits< upper_bound_type, char, ::xsd::cxx::tree::schema_type::double_ > upper_bound_traits;

      const upper_bound_type&
      upper_bound () const;
      ...
      ::xsd::cxx::tree::one< upper_bound_type > upper_bound_;
...
#endif // VER_0_3_PFC_SCENARIO_COMPLEX_TYPES_0_3_HXX
