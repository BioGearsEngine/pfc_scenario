...
namespace schema {
  ...
  public:
    ...
    static auto make_trauma(::pfc::Injury const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<trauma>;
    static auto make_treatment_plan(::pfc::Treatment const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<treatment_plan>;
    static auto make_learning_objective(::pfc::Objective const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::learning_objective>;
    static auto make_citation(::pfc::Citation const* const) -> std::unique_ptr<schema::citation>;
    static auto make_scene(::pfc::Scene const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::scene>;
    static auto make_equipment(::pfc::Equipment const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::equipment>;
    static auto make_trauma_profile(::pfc::InjurySet const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::trauma_profile>;
    static auto make_assessment(::pfc::Assessment const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::assessment>;
    ...
    //!
    static auto make_citation_ref_list(QString ref_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::citation_ref_list>;
    static auto make_cpg_ref_list(QString ref_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::cpg_ref_list>;
    static auto make_equipment_ref_list(QString ref_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::equipment_ref_list>;
    static auto make_trauma_set_ref_list(QString ref_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::trauma_profile_ref_list>;
    static auto make_treatment_plan_ref_list(QString ref_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::treatment_plan_ref_list>;
    static auto make_trauma_occurance_list(QString ref_list, QString occurance_list, QString severity_list, QString description_list, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::trauma_occurence_list>;
