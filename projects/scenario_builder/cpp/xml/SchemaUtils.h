...
namespace schema {
  ...
  public:
    ...
    static auto make_trauma(Injury const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<trauma>;
    ...
    static auto make_trauma_profile(InjurySet const* const, pfc::SQLite3Driver* _db) -> std::unique_ptr<schema::trauma_profile>;
    ...
    static auto load_injuries(std::unique_ptr<schema::ScenarioSchema> scenario_schema, pfc::SQLite3Driver& _db, bool& wasSuccessful) -> std::unique_ptr<schema::ScenarioSchema>;
    static auto load_injury_sets(std::unique_ptr<schema::ScenarioSchema> scenario_schema, pfc::SQLite3Driver& _db, bool& wasSuccessful) -> std::unique_ptr<schema::ScenarioSchema>;
