...
bool SQLite3Driver::populate_equipment()
{
  ...
  std::vector<sEquipment> default_equipment = {
    ...
    { "Morphine", 3, "A narcotic pain reliever used to treat moderate to severe pain.", "Morphine is an opioid medication used to treat severe chronic pain. It has a high rate of addiction, overdose, and death.", "2;5;6;7", "Available:BOOLEAN;Volume:SCALAR,UNIT:ENUM,ml:eOption,l:eOption,gal:eOption" },
